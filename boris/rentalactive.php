...
<div class="container">
	<div class="head">
		<h1 class="display-4 text-danger text-center">Book your DREAM on wheels</h1>
...
<div class ="manageUser">
            ...
            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                  echo "<tr>
                       ...
                       <td>" .$row['toDate']."</td>
                       <td>
                           <a href='update.php?id=" .$row['bookingId']."'><button type='button' class='btn btn-danger' >Edit</button></a>
                           <a href='delete.php?id=" .$row['bookingId']."'><button type='button' class='btn btn-danger'>Delete</button></a>
                       </td>
                   </tr>" ;
               }
           } else  {
   ...
   <a href= "create.php"><button type="button" class="btn btn-danger shadow m-4" >Book YOUR dream car</button></a>
   </div>
</div>
</div>
